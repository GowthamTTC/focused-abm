...
const PRESS: NewsItem[] = [
  {
    ...
    body:
      ...
      + "better reflect the way they operate.\" Much of it is delivered through the platform "
      + "practices already order and track in — the release says practices \"can also track APP "
      + "status and upgrade progress in real time\", and APP enrolment and rebate tracking run "
      + "through AllerganAdvantage and the Allergan Partner Privileges portal. So this is a tool "
      + "change as well as a pricing change: the field has to teach it, not just announce it. "
      + "This is the same programme whose previous redesign "
