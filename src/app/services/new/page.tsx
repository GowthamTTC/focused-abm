...
async function createService(formData: FormData) {
  ...
  if (!name) redirect("/services/new?err=Give the offer a name.");
  ...
  return (
    <Shell user={user} active="services">
      ...
      <form action={createService} className="mt-6 max-w-2xl rounded-2xl glass border-0 p-5">
        ...
        <button className="mt-5 rounded-lg bg-[#263BAA] px-5 py-2.5 text-sm font-semibold text-[#14204A] hover:bg-[#1D2E86]">
