  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-sm flex-col justify-center gap-6 px-6">
      <div>
        ...
        <p className="mt-1 text-sm text-neutral-500">Connections → ranked batches → workbook.</p>
      </div>
      <form action={doLogin} className="flex flex-col gap-3 rounded-lg border border-neutral-200 bg-white p-5 shadow-sm">
        {err && <p className="text-sm text-red-600">Wrong email or password.</p>}
        ...
        <button className="mt-2 rounded bg-neutral-900 px-3 py-2 text-sm font-medium text-white hover:bg-neutral-700">Sign in</button>
      </form>
    </main>
  );
}
