  ...
  return (
    <Shell user={user} active="settings">
      ...
      <LinkedInConnect
        ...
        linkErr={link_err}
        connect={startConnect.bind(null, "/settings")}
        claim={claimLinkedInSeats.bind(null, "/settings")}
        link={linkUnipileAccountId}
      ...
      <section className="mt-6 rounded-[14px] border border-[#DDE2EE] bg-white p-6 shadow-[0_1px_2px_rgba(16,24,40,.04)]">
        ...
        <form action={scanVoice.bind(null, "/settings")} className="mt-4 flex flex-wrap items-center gap-3">
